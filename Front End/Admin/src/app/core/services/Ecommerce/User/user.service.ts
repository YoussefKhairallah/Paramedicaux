...
export class UserService {
  ...
  getUserByID(id: number): Observable<any> {
    return this.http.get(`${this.catUrl}/findbyid/${id}`);
  }
  ...
  deleteUser(id: number): Observable<any> {
    return this.http.delete(`${this.catUrl}/deleteuser/${id}`, { responseType: 'text' });
  }

 
  // create new user
  createUser(user: Object): Observable<Object> {
    return this.http.post(`${this.catUrl}/adduser`, user);
  }
