...
export class ProductsComponent implements OnInit {
  ...
  constructor(private modalService: NgbModal, private http: HttpClient, private prodServices:ProduitService, private categorieServices:CategorieService, private storage: AngularFireStorage, private produitService:ProduitService) { }
  ...
  saveProduct(){
    ...
    if(this.editable)
    {
      this.produitService.updateProduit(this.id,this.productForm.value)
      .subscribe(res => {
        this.getAllProduit();
  ...
  edit(produitedit,content){
    this.productForm.patchValue({
      nom: this.produitedit.nom,
      fournisseur: this.produitedit.fournisseur,
      prix: this.produitedit.prix,
      description: this.produitedit.description,
      qte: this.produitedit.qte,
      qteLimite: this.produitedit.qteLimite,
      categorie: this.produitedit.categorie
    });
    this.id = this.produitedit.id;
    this.editable = true;
    this.modalService.open(content);
  }
  searchFilter(e) {
